...
\todo{Add publishers to video-game entries in the bibliography (example in Doom's entry)}
\todo{Add full dates to video-game entries in the bibliography (example in Doom's entry)}
